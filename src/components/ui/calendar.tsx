...
const CALENDAR_STYLES = {
  ...
  nav_button: (variant: "outline") => 
    cn(buttonVariants({ variant }), "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"),
  nav_position: {
  ...
  day: {
    base: (variant: "ghost") => 
      cn(buttonVariants({ variant }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100"),
