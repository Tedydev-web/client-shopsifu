		...
		<footer className="bg-white border-t text-sm">
			...
			<div className="container mx-auto px-4 py-8">
				<div className="max-w-5xl mx-auto">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 xl:gap-x-8 gap-y-6">
				...
				<div className="mt-6 pt-8 border-t bg-gray-50/50">
					<div className="flex flex-col sm:flex-row justify-between items-center gap-8 max-w-5xl mx-auto px-4">						{/* Payment Methods */}
						<div className="text-center sm:text-left sm:flex-1">
							<h3 className="font-medium mb-4 text-gray-900 text-base">Phương thức thanh toán</h3>
							<div className="inline-flex flex-wrap justify-center sm:justify-start gap-2 p-3 bg-gray-50 rounded-xl border border-gray-100 shadow-sm">							{paymentTypes.map((type) => (
									<ModernPaymentIcon
										key={type}
										type={type}
										size={44}
						...
						<div className="text-center sm:text-left">
							...
							<div className="inline-flex items-center justify-center sm:justify-start gap-2 p-3 bg-gray-50 rounded-xl border border-gray-100 shadow-sm">
								<a
									href="#"
									target="_blank"
