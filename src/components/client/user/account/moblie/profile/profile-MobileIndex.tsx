  ...
  return (
    <div className="px-4 pt-4 pb-8 space-y-4 text-sm text-black bg-white">
      ...
      {/* <div className="flex items-center justify-between border-b py-3">
        <div className="text-black font-medium">{t("user.account.profile.phone")}</div>
        <Button className="bg-red-600 rounded-full px-4 py-1 h-7 text-xs text-white">
          {t("user.account.profile.add")}
        </Button>
      </div> */}
      ...
      <div className="flex items-center justify-between border-b py-3">
        <div className="flex flex-col space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm mt-1">{userInfo.email}</p>
          </div>
          <div>
            <p className="text-black font-medium">
        ...
        <Button
          ...
          className="bg-red-600 rounded-full px-4 py-1 h-7 text-xs text-white self-start"
        >
