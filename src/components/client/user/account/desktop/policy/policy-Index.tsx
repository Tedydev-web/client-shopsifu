...
export default function PolicyIndex() {
  return (
    <div className="max-w-[1200px] mx-auto bg-white p-8 text-base leading-relaxed">
      <h1 className="text-2xl font-bold text-[#d70018] mb-6">
        Chính sách bảo hành
      </h1>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>Sản phẩm còn thời hạn bảo hành theo quy định của nhà sản xuất.</li>
      ...
      <section className="space-y-4 mt-8">
        ...
        <p>
          Thời gian xử lý bảo hành từ 7 - 14 ngày làm việc tùy tình trạng sản phẩm.
        </p>
      </section>
    </div>
  );
