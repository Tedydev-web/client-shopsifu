...
const tabClass =
  "rounded-none no-underline whitespace-nowrap px-3 py-2 text-sm data-[state=active]:text-red-500 data-[state=active]:border-b data-[state=active]:shadow-none";
...
export const OrderTabs = () => {
  ...
  // Cập nhật trạng thái hiển thị mũi tên trái/phải
  const updateArrows = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ref={scrollRef}
        className="w-full overflow-x-auto scrollbar-hide pr-6"
      >
        <TabsList className="min-w-max flex gap-2 rounded-none bg-transparent px-2 py-2 h-14">
