...
export const metadata: Metadata = {
  metadataBase: new URL("https://shopsifu.vn/"),
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/shopsifu-banner.jpg", // 👉 thay bằng banner thực tế
        width: 1200,
        height: 630,
